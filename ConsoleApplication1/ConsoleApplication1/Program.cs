...
namespace ConsoleApplication1
{
	class Program:ServiceHost
	{
		...
		static void Main(string[] args)
		{
			...
			IService1 t = new Service1Client(binding, adress);
			Console.WriteLine(t.GetDataWithService2(123123));
			Console.WriteLine(t.GetData(000000000));
			//Service1Client f = new Service2Client();

			//var mexx = new MetadataExchangeClient(new EndpointAddress("http://katusha:8733/trololo/mex"));
			//var metadata = mexx.GetMetadata();
